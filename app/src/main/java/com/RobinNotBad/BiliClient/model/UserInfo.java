...
public class UserInfo implements Parcelable, Serializable {
    ...
    public int relationAttribute;
    public int beRelationAttribute;
    ...
    public UserInfo(long mid, String name, String avatar, String sign, int fans, int following, int level, boolean followed, String notice, int official, String officialDesc, int is_senior_member) {
        ...
        this.relationAttribute = followed ? 2 : 0;
        this.notice = notice;
    ...
    protected UserInfo(Parcel in) {
        ...
        followsMe = in.readByte() != 0;
        relationAttribute = in.readInt();
        beRelationAttribute = in.readInt();
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte((byte) (followsMe ? 1 : 0));
        dest.writeInt(relationAttribute);
        dest.writeInt(beRelationAttribute);
