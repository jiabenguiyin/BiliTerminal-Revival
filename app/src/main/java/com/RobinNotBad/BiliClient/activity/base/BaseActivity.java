...
public class BaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            details.put("screen", getClass().getSimpleName());
            DiagnosticLogManager.record("screen_open", details);
    ...
    public void report(Exception e) {
        try {
            org.json.JSONObject details = new org.json.JSONObject();
            details.put("screen", getClass().getSimpleName());
            details.put("error", e == null ? "unknown" : e.getClass().getSimpleName());
            DiagnosticLogManager.record("screen_error", details);
        } catch (org.json.JSONException ignored) {
        }
