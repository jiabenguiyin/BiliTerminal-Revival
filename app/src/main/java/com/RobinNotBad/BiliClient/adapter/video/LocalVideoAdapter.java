            ...
            holder.itemView.setOnClickListener(view -> {
                if (localVideo.videoFileList != null && localVideo.videoFileList.size() == 1) {
                    ...
                    try {
                        ...
                        // 如果是仅音频文件，标记为音频模式
                        if (localVideo.audioOnlyList != null && !localVideo.audioOnlyList.isEmpty()
                                && Boolean.TRUE.equals(localVideo.audioOnlyList.get(0))) {
                            player.putExtra("audio_only", true);
                        }
                        if (localVideo.subtitleFolderLocators != null
                    ...
                    intent.putExtra("subtitleFolderLocators", localVideo.subtitleFolderLocators);
                    intent.putExtra("pageFolderLocators", localVideo.pageFolderLocators);
                    intent.putExtra("folderLocator", localVideo.folderLocator);
                    intent.putExtra("audioOnlyList", localVideo.audioOnlyList);
