...
public class LiveApi {
    ...
    public static List<LiveRoom> getRecommend(int page) throws JSONException, IOException {
        String url = "https://api.live.bilibili.com/xlive/web-interface/v1/"
                + (page <= 1 ? "webMain/getList" : "webMain/getMoreRecList")
        ...
        if (data != null) {
            JSONArray list = data.optJSONArray("recommend_room_list");
            if (list != null) {
